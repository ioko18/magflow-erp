...
2. [HighLatencySlowBurn](#highlatencyslowburn)
3. [HighErrorRateFastBurn](#higherrorratefastburn)
4. [HighErrorRateSlowBurn](#higherrorrateslowburn)
5. [ServiceDegraded](#servicedegraded)
...
2. **If Caused by Database Issues**
   - Check for long-running queries
   - Verify database connection pool settings
   - Check for table/index bloat

3. **If Caused by Application Issues**
...
2. Secondary On-call: @senior-dev
