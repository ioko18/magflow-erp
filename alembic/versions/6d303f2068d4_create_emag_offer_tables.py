...
def upgrade() -> None:
    ...
    if 'emag_products' not in existing_tables:
        ...
        op.create_index(
            "ix_emag_products_part_number",
            "emag_products",
            ["part_number"],
            schema="app",
        )
        op.create_index(
            "ix_emag_products_category",
            "emag_products",
            ["emag_category_id"],
            schema="app",
        )
        op.create_index(
            "ix_emag_products_brand",
            "emag_products",
            ["emag_brand_id"],
            schema="app",
        )
    ...
    if 'emag_product_offers' not in existing_tables:
        op.create_table(
            ...
            sa.Column(
                "product_id",
                sa.Integer(),
                sa.ForeignKey("app.emag_products.id", ondelete="SET NULL"),
                nullable=True,
            ),
        ...
        op.create_index(
            "idx_emag_offer_product",
            "emag_product_offers",
            ["emag_product_id"],
            schema="app",
        )
        op.create_index(
            "idx_emag_offer_status",
            "emag_product_offers",
            ["status"],
            schema="app",
        )
        op.create_index(
            "idx_emag_offer_imported",
            "emag_product_offers",
            ["last_imported_at"],
            schema="app",
        )
        op.create_index(
            "idx_emag_offer_batch",
            "emag_product_offers",
            ["import_batch_id"],
            schema="app",
        )
    ...
    if 'emag_offer_syncs' not in existing_tables:
        ...
        op.create_index(
            "idx_emag_sync_status",
            "emag_offer_syncs",
            ["status"],
            schema="app",
        )
        op.create_index(
            "idx_emag_sync_account",
            "emag_offer_syncs",
            ["account_type"],
            schema="app",
        )
        op.create_index(
            "idx_emag_sync_started",
            "emag_offer_syncs",
            ["started_at"],
            schema="app",
        )
        op.create_index(
            "idx_emag_sync_completed",
            "emag_offer_syncs",
            ["completed_at"],
            schema="app",
        )
    ...
    if 'emag_import_conflicts' not in existing_tables:
        op.create_table(
            ...
            sa.Column(
                ...
                sa.ForeignKey("app.emag_offer_syncs.sync_id", ondelete="CASCADE"),
                nullable=False,
            ),
        ...
        op.create_index(
            "idx_emag_conflicts_sync",
            "emag_import_conflicts",
            ["sync_id"],
            schema="app",
        )
        op.create_index(
            "idx_emag_conflicts_offer",
            "emag_import_conflicts",
            ["emag_offer_id"],
            schema="app",
        )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_emag_conflicts_offer",
        table_name="emag_import_conflicts",
        schema="app",
    )
    op.drop_index(
        "idx_emag_conflicts_sync",
    ...
    op.drop_index(
        "idx_emag_offer_batch",
        table_name="emag_product_offers",
        schema="app",
    )
    op.drop_index(
        "idx_emag_offer_imported",
    ...
    op.drop_constraint(
        "uq_emag_product_offers_offer_id",
        "emag_product_offers",
        type_="unique",
        schema="app",
    )
