...
class FullEmagSync:
    ...
    def __init__(self, account_type: str = "main"):
        ...
        # Database connection
        self.db_url = (
            "postgresql://app:pQ4mR9tY2wX7zK3nL8vB5cD1fG6hJ0@localhost:5433/magflow"
        )
        ...
        try:
            ...
            for product_data in products:
                try:
                    ...
                    if existing:
                        # Update existing product in emag_products_v2
                        cur.execute(
                            """
                        ...
                        # Create new product in emag_products_v2
                        product_id = str(uuid.uuid4())
                        cur.execute(
                            """
                            INSERT INTO app.emag_products_v2 (
    ...
    async def _fetch_products_from_emag(self, max_pages: int):
        ...
        for page in range(1, max_pages + 1):
            ...
            # Conform eMAG API v4.4.9: POST body format
            data = {"currentPage": page, "itemsPerPage": 100}
