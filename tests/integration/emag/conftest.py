...
from app.integrations.emag.config import get_settings


DEFAULT_EMAG_ENV = {
    "EMAG_API_BASE_URL": "https://marketplace-api.emag.ro/api-3",
    "EMAG_MAIN_USERNAME": "test_main_user",
    "EMAG_MAIN_PASSWORD": "test_main_pass",
    "EMAG_MAIN_WAREHOUSE_ID": "1001",
    "EMAG_MAIN_IP_WHITELIST_NAME": "86.124.202.185",
    "EMAG_MAIN_CALLBACK_BASE": "https://test-main.magflow.local/callback",
    "EMAG_MAIN_ACCOUNT_TYPE": "main",
    "EMAG_FBE_USERNAME": "test_fbe_user",
    "EMAG_FBE_PASSWORD": "test_fbe_pass",
    "EMAG_FBE_WAREHOUSE_ID": "2002",
    "EMAG_FBE_IP_WHITELIST_NAME": "86.124.202.185",
    "EMAG_FBE_CALLBACK_BASE": "https://test-fbe.magflow.local/callback",
    "EMAG_FBE_ACCOUNT_TYPE": "fbe",
}


@pytest.fixture(autouse=True)
def emag_environment(monkeypatch):
    """Set default environment variables and reset settings cache for each test."""

    for key, value in DEFAULT_EMAG_ENV.items():
