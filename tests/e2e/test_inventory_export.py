...
class TestInventoryExport:
    ...
    async def test_export_excel_with_account_filter(
        ...
        while sheet[f"A{row}"].value:
            ...
            assert account_type == "MAIN", (
                f"Row {row} has account type {account_type}, expected MAIN"
            )
            row += 1
    ...
    async def test_export_excel_formatting(
        self,
        async_client: AsyncClient,
        test_products,
        auth_headers,
    ...
    async def test_export_excel_summary_section(
        self,
        async_client: AsyncClient,
        test_products,
        auth_headers,
    ...
    async def test_export_excel_unauthorized(
        self,
        async_client: AsyncClient,
    ):
...
class TestExportIntegration:
    ...
    async def test_export_after_inventory_update(
        self,
        async_client: AsyncClient,
        test_products,
        auth_headers,
