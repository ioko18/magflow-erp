...
class EmagResponseValidator:
    ...
    def validate(
        self, response: dict[str, Any], url: str, operation: str = ""
    ) -> dict[str, Any]:
        """
        ...
        if response.get("isError"):
            ...
            if self._is_documentation_error(messages):
                ...
                warning_msg = (
                    f"Documentation error for {operation} but offer saved: {messages}"
                )
    ...
    def _send_critical_alert(
        self, alert_type: str, url: str, response: dict[str, Any], operation: str
    ):
        """
...
def validate_emag_response(
    response: dict[str, Any], url: str, operation: str = ""
) -> dict[str, Any]:
    """
