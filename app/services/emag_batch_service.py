...
class EmagBatchService:
    ...
    def __init__(self, account_type: str = "main"):
        ...
        logger.info(
            "Initialized EmagBatchService for %s account",
            account_type
        )
    ...
    def _create_batches(self, items: List[Any], batch_size: int = None) -> List[List[Any]]:
        """
            ...
            for batch_idx, batch in enumerate(batches, 1):
                try:
                    ...
                    if response.get('isError'):
                        ...
                        error_msg = f"Batch {batch_idx} failed: {response.get('messages')}"
