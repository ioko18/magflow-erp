...
class EmagInvoiceService:
    ...
    async def initialize(self):
        ...
        logger.info(
            "Initialized eMAG invoice service for %s account", self.account_type
        )
    ...
    async def generate_invoice_data(self, order_id: int) -> dict[str, Any]:
    ...
    async def bulk_generate_invoices(self, order_ids: list[int]) -> dict[str, Any]:
        ...
        for order_id in order_ids:
            try:
                ...
                logger.error(
                    "Failed to generate invoice for order %d: %s", order_id, str(e)
                )
    ...
    async def _generate_invoice_pdf(self, invoice_data: dict[str, Any]) -> str:
