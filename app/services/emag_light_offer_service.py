...
class EmagLightOfferService:
    ...
    def __init__(self, account_type: str = "main"):
        ...
        logger.info(
            "Initialized EmagLightOfferService for %s account",
            account_type
        )
    ...
    async def update_offer_price(
        ...
        logger.info(
            "Updating price for product %d: sale_price=%.2f",
            product_id,
            sale_price
        )
        ...
        try:
            ...
            logger.error("Failed to update price for product %d: %s", product_id, str(e))
    ...
    async def update_offer_stock(
        ...
        try:
            ...
            logger.error("Failed to update stock for product %d: %s", product_id, str(e))
    ...
    async def update_offer_price_and_stock(
        ...
        try:
            ...
            logger.error("Failed to update offer for product %d: %s", product_id, str(e))
    ...
    async def update_offer_status(
        ...
        logger.info(
            "Updating status for product %d: status=%s",
            product_id,
            status_text
        )
        ...
        try:
            ...
            logger.error("Failed to update status for product %d: %s", product_id, str(e))
