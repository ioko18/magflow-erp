...
class UserUpdate(BaseModel):
    ...
    full_name: Optional[str] = Field(None, description="User's full name")
    password: Optional[str] = Field(None, min_length=8, max_length=72, description="New password (8-72 characters)")
...
class UserInDBBase(UserBase):
    ...
    avatar_url: Optional[HttpUrl] = Field(None, description="URL to user's avatar image")
...
class Msg(BaseModel):
    ...
    msg: str = Field(..., description="A message describing the result of the operation")
