...
class Invoice(Base, TimestampMixin):
    ...
    # eMAG integration
    emag_invoice_id: Mapped[str | None] = mapped_column(String(100), nullable=True)
    account_type: Mapped[str] = mapped_column(String(10), default="main")  # main/fbe

    # Processing information
    issued_by: Mapped[int | None] = mapped_column(Integer, nullable=True)  # user_id
    issued_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    sent_by: Mapped[int | None] = mapped_column(Integer, nullable=True)  # user_id
...
class TaxCalculation(Base, TimestampMixin):
    ...
    item_ids: Mapped[str | None] = mapped_column(
        Text,
        nullable=True,
