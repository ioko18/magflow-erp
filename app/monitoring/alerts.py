...
class AlertRule(BaseModel):
    ...
    condition: str = Field(..., description="Condition expression (e.g., '> 90%' or '== 0')")
    duration: str = Field("5m", description="Duration the condition must be true before alerting")
