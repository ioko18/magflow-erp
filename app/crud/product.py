...
class ProductCRUD:
    ...
    async def list_products(
        ...
        has_emag_mapping: Optional[bool] = None,
    ...
    async def create_product(
        ...
        product_dict = product_data.model_dump(
            exclude={"category_ids", "auto_publish_emag", "characteristics", "images", "attachments"}
        )
    ...
    async def update_product(
        ...
        update_dict = update_data.model_dump(
            exclude_unset=True,
            exclude={"category_ids", "sync_to_emag", "characteristics", "images", "attachments"}
        )
    ...
    async def validate_product(
        ...
        if hasattr(product_data, 'warranty_months'):
            if product_data.warranty_months is not None and product_data.warranty_months < 0:
        ...
        dimensions = [product_data.length_cm, product_data.width_cm, product_data.height_cm]
